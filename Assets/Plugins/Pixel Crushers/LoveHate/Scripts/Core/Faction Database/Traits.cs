...
namespace PixelCrushers.LoveHate
{
    ...
    public class Traits : MonoBehaviour
    {
        ...
        /// </summary>
        /// <returns>
        /// A value in the range 0 to 1 indicating how well the values align, where 0 indicates 
        /// maximum opposites and 1 indicates complete alignment.
        /// </returns>
        /// <param name="a">The first set of values.</param>
        /// <param name="b">The second set of values. Both arrays should be the same length.</param>
