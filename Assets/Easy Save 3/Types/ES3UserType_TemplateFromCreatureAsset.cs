		...
		protected override void ReadObject<T>(ES3Reader reader, object obj)
		{
			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					instance = (SunsetSystems.Entities.Characters.CreatureConfig.TemplateFromCreatureAsset)reader.SetPrivateField("<BaseLookWardrobeCollectionID>k__BackingField", reader.Read<System.Int16>(), instance);
					break;
