        ...
        private void UpdateGridVisual()
        {
            ...
            /*switch (selectedAction)
            {
                ...
                case ShootAction shootAction:
                    ...
                    int maxShootDistance = WeaponManager.Instance.GetMaxShootDistance();

                    ShowGridPositionRange(selectedUnit.GetGridPosition(), maxShootDistance, GridVisualType.RedSoft);
                    break;
            }
