...
namespace Entities.Characters.Data
{
    ...
    public class CreatureData : EntityData
    {
        ...
        private CreatureData(string name, Sprite portrait, HealthData healthData, int hunger)
        {
            this.name = name;
        ...
        public class CreatureDataBuilder : EntityDataBuilder<CreatureData>
        {
            private string name;
            ...
            public override CreatureData create()
            {
                return new CreatureData(name, portrait, healthData, hunger);
            }
        }
    }
