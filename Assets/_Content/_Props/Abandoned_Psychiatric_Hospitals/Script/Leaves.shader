	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord154 = packedInput.ase_texcoord5.xy * _Tilling + float2( 0,0 );
				...
				float3 unpack115 = UnpackNormalScale( tex2D( _Normal, uv_Normal ), _Normal_Power );
				unpack115.z = lerp( 1, unpack115.z, saturate(_Normal_Power) );
				
				float2 uv_Mask = packedInput.ase_texcoord5.xy * _Mask_ST.xy + _Mask_ST.zw;
				float4 tex2DNode15 = tex2D( _Mask, uv_Mask );
				
				float lerpResult168 = lerp( 1.0 , packedInput.ase_color.r , _Ambient_Occlusion);
				
				surfaceDescription.Albedo = ( ( _Color * tex2DNode89 ) + ( _Color_Tilling * tex2DNode89 * simplePerlin2D152 ) ).rgb;
				surfaceDescription.Normal = unpack115;
				...
				surfaceDescription.Smoothness = ( _Smoothness_Power * tex2DNode15.g );
				surfaceDescription.Occlusion = lerpResult168;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_Base_Color = packedInput.ase_texcoord.xy * _Base_Color_ST.xy + _Base_Color_ST.zw;
				float4 tex2DNode89 = tex2D( _Base_Color, uv_Base_Color );
				float2 texCoord154 = packedInput.ase_texcoord.xy * _Tilling + float2( 0,0 );
				float simplePerlin2D152 = snoise( texCoord154*_Tilling_Color );
				simplePerlin2D152 = simplePerlin2D152*0.5 + 0.5;
		...
		Pass
		{
						...
						)
			{
				...
				float4 tex2DNode89 = tex2D( _Base_Color, uv_Base_Color );
				float2 texCoord154 = packedInput.ase_texcoord7.xy * _Tilling + float2( 0,0 );
				float simplePerlin2D152 = snoise( texCoord154*_Tilling_Color );
				simplePerlin2D152 = simplePerlin2D152*0.5 + 0.5;
...
/*ASEBEGIN
Version=18921
-1913;20;1906;999;684.8195;641.7543;1.3;True;False
Node;AmplifyShaderEditor.RangedFloatNode;22;-2009.076,1121.477;Float;False;Property;_Wind_Size;Wind_Size;5;0;Create;True;0;0;0;False;0;False;0.5;0.131;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;25;-1358.345,1508.736;Float;False;Property;_WindSpeed;Wind Speed;4;0;Create;True;0;0;0;False;0;False;0.2327153;0.117;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;36;-1080.616,1618.328;Float;False;Property;_WindScale;Wind Scale;2;0;Create;True;0;0;0;False;0;False;0.3622508;0.258;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;165;-1266.379,-579.7614;Inherit;False;Property;_Tilling;Tilling;14;0;Create;True;0;0;0;False;0;False;0,0;2.12,1.59;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SamplerNode;89;-850.294,-1006.769;Inherit;True;Property;_Base_Color;Base_Color;10;0;Create;True;0;0;0;False;0;False;-1;3e54ae3159a63aa45a2e61a3b5f97174;859d0d529393a2349b747f5c52ec699d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;144;19.31287,-1171.296;Inherit;False;Property;_Color;Color;1;0;Create;True;0;0;0;False;0;False;0.9716981,0.9716981,0.9716981,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;120;-244.1502,-1183.718;Inherit;False;Property;_Color_Tilling;Color_Tilling;0;0;Create;True;0;0;0;False;0;False;0.9716981,0.9716981,0.9716981,0;0.9716981,0.9716981,0.9716981,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;39;-446.3139,1537.21;Float;False;Property;_WindPower;Wind Power;3;0;Create;True;0;0;0;False;0;False;0.2506492;0.128;0;0.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;169;-315.5917,-356.7229;Inherit;False;Property;_Normal_Power;Normal_Power;8;0;Create;True;0;0;0;False;0;False;0;0.78;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;103;-600.381,-216.8072;Inherit;False;Property;_Smoothness_Power;Smoothness_Power;7;0;Create;True;0;0;0;False;0;False;0;0.19;0;3;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;167;-828.0994,109.3791;Inherit;False;Property;_Ambient_Occlusion;Ambient_Occlusion;6;0;Create;True;0;0;0;False;0;False;0;0.16;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;15;-353.4914,300.1608;Inherit;True;Property;_Mask;Mask;11;0;Create;True;0;0;0;False;0;False;-1;c7dafe54df34e3b419833d59f7bb6bdc;341c7446981d1664695c5fdeb237f187;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;130;76.33845,-120.615;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;115;54.26059,-407.1914;Inherit;True;Property;_Normal;Normal;13;1;[Normal];Create;True;0;0;0;False;0;False;-1;a4d75a807893b1049943e9b1748b4cd0;eedfd53936a19174e85ebb79f497cbe2;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;170;1;115;0
WireConnection;170;7;130;0
WireConnection;170;8;168;0
WireConnection;170;9;89;4
WireConnection;170;11;37;0
ASEEND*/
//CHKSM=19822F5EAC5F4628D345C38A89FCC32651151350