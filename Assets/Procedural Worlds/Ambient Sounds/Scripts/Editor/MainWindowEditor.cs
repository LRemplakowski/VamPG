...
namespace AmbientSounds
{
    ...
    public class MainWindowEditor : EditorWindow, IPWEditor
    {
        ...
        AnimBool Manager_HideManagerObjectGroup = null;
...
#region Tabs
        void ManagerSettingsPanel(bool inlineHelp) {
            ...
            if (Manager_HideManagerObjectGroup == null) {
        ...
        void SequencesTab() {
            ...
            if (!AssetWindowEditor.IsOpen) {
                ...
                m_editorUtils.Panel("SequencesPanel", SequencesPanel, false);
                m_editorUtils.Panel("ModifiersPanel", ModifiersPanel, false);
            }
        ...
        void SequencesPanel(bool inlineHelp) {
            ...
            foreach (Sequence data in AllSequences) {
                ...
                if (m_editorUtils.Button(EditorGUIUtility.IconContent("SceneViewAudio"), buttonStyle, GUILayout.Height(EditorGUIUtility.singleLineHeight), GUILayout.ExpandWidth(false))) {
        ...
        void Runtime_CurrentlyPlayingPanel(bool inlineHelp) {
            ...
            foreach (AmbienceManager.TrackPlayingInfo track in AllTracks) {
                ...
                if (track.m_sequence != null) {
                    ...
                    if (m_editorUtils.Button(EditorGUIUtility.IconContent("SceneViewAudio"), buttonStyle, GUILayout.ExpandWidth(false))) {
                        if (Event.current.button == 1) {
