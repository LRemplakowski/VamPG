...
namespace PixelCrushers.LoveHate
{
    ...
    public class FactionManager : MonoBehaviour
    {
        ...
        private FactionDatabase m_originalDatabase;
        ...
        protected virtual void Awake()
        {
            ...
            m_instance = this;
            m_originalDatabase = factionDatabase;
            Initialize();
        }
        ...
        private void Initialize()
        {
            ...
            factionDatabase = Instantiate(m_originalDatabase) as FactionDatabase;
            m_factions.Clear();
        ...
        public virtual void ResetAll()
        {
            ...
            Initialize();
            foreach (var memberList in m_members.Values)
            {
                memberList.ForEach(member => member.ResetAll());
            }
        }
