		...
		protected override void ReadObject<T>(ES3Reader reader, object obj)
		{
			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					instance = (SunsetSystems.Entities.Characters.CreatureConfig.TemplateFromCreatureAsset)reader.SetPrivateField("<EquipmentSlotsData>k__BackingField", reader.Read<System.Collections.Generic.Dictionary<SunsetSystems.Equipment.EquipmentSlotID, SunsetSystems.Equipment.IEquipmentSlot>>(), instance);
					break;
