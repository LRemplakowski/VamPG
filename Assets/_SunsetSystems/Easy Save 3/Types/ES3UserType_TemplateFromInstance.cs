		...
		protected override void ReadObject<T>(ES3Reader reader, object obj)
		{
			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					instance = (SunsetSystems.Entities.Characters.Creature.TemplateFromInstance)reader.SetPrivateField("<PortraitAssetRef>k__BackingField", reader.Read<UnityEngine.AddressableAssets.AssetReferenceSprite>(), instance);
					break;
