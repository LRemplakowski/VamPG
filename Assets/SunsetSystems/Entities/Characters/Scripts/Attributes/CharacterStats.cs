...
{
    [SerializeField, Tooltip("Czy dane statystyki są generyczne, czy przeznaczone dla unikalnej postaci?")]
    private bool _isGeneric;
    /// <summary>
    /// Czy dane statystyki są generyczne, czy przeznaczone dla unikalnej postaci. Generyczne statystyki powinny być skopiowane do nowej instacji assetu, żeby nie modyfikować instancji bazowej.
    /// </summary>
    ...
    /// <returns>Nową instancję assetu.</returns>
